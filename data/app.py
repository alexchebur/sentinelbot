...
from test import FileHandler, QuizHandler  # Импорт класса теста и скачивания файла pdf
...
USER_RATE_LIMIT = 8
MESSAGE_BROADCAST_INTERVAL = 604800
...
- Если запрос пользователя абсолютно не касается вопросов противодействия коррупции, отвечай: "Боюсь, ваш вопрос не относится к антикоррупционному комплаенс, попробуйте его переформулировать"
...
def main():
    ...
    file_handler = FileHandler() #запуск класса скачивания файла из файла test.py
