...
USER_RATE_LIMIT = 8
MESSAGE_BROADCAST_INTERVAL = 120
...
- Делай ссылки на названия документов, если они указаны. Если названия документов не указаны, то не пиши об этом.
- Запрещено указывать расширение TXT документа, только название.
- Придумай три дополнительных вопроса в имеющемся контексте. Напиши их в конце ответа, начиная с фразы: "Также вам могли бы быть интересны вопросы 💬:"
...
class AnticorruptionBot:
    ...
    async def handle_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await self._safe_send(
            update,
            "Привет! Задайте мне вопрос по антикоррупционным нормативным актам."
        )
